...
class PaymentMethod extends \Magento\Payment\Model\Method\AbstractMethod {
    ...
    public function getPostHTML($order, $acuid, $storeId = null) {
        ...
        $gateway_url = 'https://www.paytabs.com/apiv2/create_sadad_payment';
        ...
        $request_param = array(
            ...
            'country_shipping' => $shpcountry_iso2,
        ...
        $response_data = $this->_sendRequest($gateway_url, $request_string);
